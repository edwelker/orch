...
INSERT INTO "auth_user" VALUES(1,'ewelker','','','ewelker@cdepot.com','sha1$17872$ed010e2b63a304878bdddb72fd11df8f6d5dd1cb',1,1,1,'2010-06-12 00:14:57.707100','2010-06-12 00:14:25.526220');
...
INSERT INTO "django_flatpage_sites" VALUES(2,6,1);
...
INSERT INTO "django_flatpage_sites" VALUES(8,5,1);
...
INSERT INTO "django_flatpage_sites" VALUES(14,10,1);
...
<p>
  In 2005, the organization established an administrative office at the Howard County Center for the Arts and released its first commercial recording, <em>Flying Home: A Tribute to John Denver,</em> performing with members and songwriters of the original John Denver Band.
</p>
<p>
...
<p>
  As it enters its 31st season, the Columbia Orchestra has positioned itself for a record year of artistic and organizational accomplishments as it strives to remain "your community''s music."
</p>
</div>',0,'',0);
...
<p>The Columbia Orchestra presents a series of "Preludes," a discussion series held before each Classical Concert. This enlightening, entertaining series allows you to experience the stories and ideas behind the concert''s selections in an interesting, informal setting. Each free session runs from 6:30-7:10 (Subscribers can still take advantage of priority seating at 7:10.)</p>

<img src="/images/Prelude_discussion.jpg" alt="Bill Scanlan Murphy giving a Prelude lecture" style="float:right" height="125" width="275">
...
<img src="/images/p-murphy.jpg" style="float: right" height="160" width="125"/>
...
<p>Ms. Li performs on a Nicolo Gagliano violin, was crafted in 1736, Naples.</p>','qing-li','src_imgs/soloists/QingLi.jpg',21);
...
','stan-gilmer','src_imgs/soloists/Stan_Gilmer.jpg',26);
...
<p>Born in Burlington, North Carolina, Love studied violoncello with Ronald Thomas and conducting with Frederik Prausnitz at the Peabody Conservatory. He is Past President of the Peabody Alumni Association.</p>','src_imgs/members/Jason_Love.jpg',46,0);
...
<p>Fun Fact #3 = I love going to rock concerts on my free time. I have been to a rock concert each month since October 2008.</p>','',4,0);
...
<p>Interesting Fact #3: I have traveled to South Korea, Iceland, England, Wales, Scotland, Czech Republic, Bratislava, and Austria.</p>','',3,0);
...
<p>After years of playing these different genres of music, I have to say that playing the full orchestral works of the great compers such as Mozart, Beethoven, Tchaikovsky is a source of great satisfaction and I am glad that the Columbia Orchestra makes this music available to our community.</p>','src_imgs/members/PatrickFemiano.jpg',14,0);
...
<p>I cherish Monday nights with the Columbia Orchestra.  I can get away from my real life as a Human Resources Manager and do what I really love.  It feeds my soul.</p>','src_imgs/members/AnnemarieScimonelli.jpg',5,0);
...
</ul>','src_imgs/members/HannahOliver.jpg',13,0);
...
<p>I have always preferred orchestral music, but recently I have taken up jazz again, folk/blue grass, and chamber music. Music will continue to play a major role in my life as I enter retirement years.</p>','src_imgs/members/AlMcLaine.JPG',4,0);
...
INSERT INTO "roster_orchestramember" VALUES(60,'Kathrin','','Kucharski',6,0,0,0,'<p>Kathrin Kucharski has played flute since she was ten years old and studied flute under Kathleen Trahan from the University of Maryland College Park School of Music.  She has played in a number of community church groups, performed with the Prince Georges County Orchestra and currently serves as second flute/piccolo for the Columbia Orchestra in Columbia Maryland.  In her “real” life, she is a wife, mom of two boys and a medical liaison pharmacist for sanofi-aventis pharmaceuticals.</p>','src_imgs/members/KathrinKucharski.jpg',7,0);
...
<p>If you are in the market for any home improvements, please check my ad in the Orchestra Programs.</p>','src_imgs/members/Randy2.jpg',8,0);
...
<p>Meredith has been an active harpist for weddings, receptions, and all special events for over 20 years. Ms. Mancini is a published arranger for harp ensembles, solos, and musical scores.</p>','src_imgs/members/MeredithMancini.jpg',4,0);
...
<p>Mr. Stewart is a candidate for the Doctor of Musical Arts Degree in Orchestral Conducting at The Catholic University of America in Washington, D.C, where he studies with Maestro David Searle. He has also studied with Kenneth Kiesler and Gustav Meier.</p>','',4,0);
